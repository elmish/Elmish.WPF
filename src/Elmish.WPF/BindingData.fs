...
and internal ValidationData<'model, 'msg, 't> =
  { BindingData: BindingData<'model, 'msg, 't>
    Validate: 'model -> string list }


and internal LazyData<'model, 'msg, 'bindingModel, 'bindingMsg, 't> =
...
and internal AlterMsgStreamData<'model, 'msg, 'bindingModel, 'bindingMsg, 'dispatchMsg, 't> =
 { BindingData: BindingData<'bindingModel, 'bindingMsg, 't>
   Get: 'model -> 'bindingModel
...
and internal BaseBindingData<'model, 'msg, 't> =
...
and internal BindingData<'model, 'msg, 't> =

...
module BindingData =
  ...
  module SubModel =
    ...
    let measureFunctions mGetModel mGetBindings mToMsg =
      mapFunctions
  ...
  module SubModelWin =
    ...
    let measureFunctions mGetState mGetBindings mToMsg =
      mapFunctions
        (mGetState "getState")
        (mGetBindings "bindings") // sic: "getBindings" would be following the pattern
        (mToMsg "toMsg")
  ...
  module SubModelSeqUnkeyed =
    ...
    let measureFunctions mGetModels mGetBindings mToMsg =
      mapFunctions
  ...
  module SubModelSeqKeyed =
    ...
    let measureFunctions mGetSubModels mGetBindings mToMsg mGetId =
      mapFunctions (mGetSubModels "getSubModels") (mGetBindings "getBindings") (mToMsg "toMsg") (mGetId "getId")
